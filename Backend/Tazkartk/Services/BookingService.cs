...
namespace Tazkartk.Services
{
    public class BookingService : IBookingService
    {
        ...
        {
            var booking = await _context.bookings.Include(b => b.trip).ThenInclude(t => t.company).Include(b => b.payment).FirstOrDefaultAsync(b => b.UserId == id); var Ticket = await _context.bookings.FindAsync(id);
